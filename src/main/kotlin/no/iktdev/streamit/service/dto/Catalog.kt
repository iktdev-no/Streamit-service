...
import no.iktdev.streamit.service.db.tables.content.CatalogTableObject
import no.iktdev.streamit.service.db.tables.content.MovieTable
import no.iktdev.streamit.service.db.tables.content.CatalogTableRecentlyUpdatedSeriesObject
...
open class Catalog(
    ...
    companion object {
        ...
        fun fromTable(item: CatalogTableRecentlyUpdatedSeriesObject, recent: Boolean = false) = Catalog(
            id = item.id,
            title = item.title,
            cover = item.cover,
            type = item.type.let {
